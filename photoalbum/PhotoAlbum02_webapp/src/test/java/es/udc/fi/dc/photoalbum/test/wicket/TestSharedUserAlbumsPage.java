...
/**
 */
public class TestSharedUserAlbumsPage {
    private WicketApp wicketApp;
    private WicketTester tester;
    private User owner = new User(1, USER_USERNAME_EXIST, USER_EMAIL_EXIST,
            USER_PASS_YES);
    private User user = new User(2, "a", "a@a.com", USER_PASS_YES);

    private Album album = new Album(1, ALBUM_NAME_EXIST, owner,
            ...
            protected void init() {
                ...
                ShareInformationPhotosService mockShareFile = new ShareInformationPhotosService() {
                    ...
                    public ArrayList<ShareInformationPhotos> getPhotosShares(
                            int photoId) {
                        ShareInformationPhotos sip = new ShareInformationPhotos(
                                1, file, user);
                ...
                ShareInformationAlbumsService mockShareAlbum = new ShareInformationAlbumsService() {
                    ...
                    public ArrayList<ShareInformationAlbums> getUserShares(
                            int userId) {
                        ShareInformationAlbums sia = new ShareInformationAlbums(
                                1, album, user);
                        ArrayList<ShareInformationAlbums> list = new ArrayList<ShareInformationAlbums>();
                        list.add(sia);
                        return list;
                    }
                    ...
                    public ShareInformationAlbums getShare(int albumId,
                            int userSharedToId) {
                        return new ShareInformationAlbums(2, album, user);
                    }
    ...
    public void setUp() {
        ...
        Page page = new SharedUserAlbums(pars);
    ...
    public void testRendered() {
        tester.assertRenderedPage(SharedUserAlbums.class);
    }
}
